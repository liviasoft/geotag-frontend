<script lang="ts" setup>
  ...
  const playlist = ref([
    ...
    {command: 'UNIT:POW DBM/M2', description: 'Configure Measurement Units', id: 19, timeout: 3000},
    {command: 'DISP:WIND:TRAC:Y:SCAL:RLEV -5 DBM/M2', description: 'Set Device Display Window Trace Offset', id: 20, timeout: 3000},
