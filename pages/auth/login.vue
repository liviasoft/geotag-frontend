...
<template>
  <div>
    ...
    <v-tabs-window v-model="tab">
      ...
      >
        ...
        >
          ...
          <div v-if="item=== 'Email'">
            <v-text-field density="compact" prependInnerIcon="mdi-account" label="Email or Username" variant="outlined" class="pt-4"></v-text-field>
    ...
    <NuxtLink to="/auth/register" style="text-decoration: none;">
      <v-btn block color="secondary" class="mt-4">Create An Account</v-btn>
    </NuxtLink>
  </div>
</template>